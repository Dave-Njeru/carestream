    ...
    try {
        ...
        if ($stmt = $conn->prepare($sql)) {
            ...
            if ($stmt->affected_rows > 0) {
                ...
                $mail->SMTPAuth = true;
                $mail->Username = 'davenjeru9@gmail.com';
                $mail->Password = 'bfih clvs mosf hxwk';
                $mail->SMTPSecure = 'tls';
                $mail->Port = 587;
                ...
                alert("An error occurred during registration. " . $conn->error);
            }

            $stmt->close();
        } else {
            alert("SQL statement preparation failed: " . $conn->error);
        }
