        ...
        <aside class="w-64 bg-white shadow-md hidden md:block">
            ...
            <nav class="mt-8">
                <a href="<?= BASE_URL ?>/patient" class="block px-6 py-3 text-gray-700 font-bold hover:bg-blue-50">Dashboard</a>
                <a href="<?= BASE_URL ?>/patient/appointments" class="block px-6 py-3 text-gray-700 hover:bg-blue-50">Appointments</a>
